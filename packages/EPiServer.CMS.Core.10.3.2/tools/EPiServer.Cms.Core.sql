...
GO
CREATE NONCLUSTERED INDEX [IDX_tblApprovalDefinitionApprover_fkApprovalDefinitionVersionID]
    ON [dbo].[tblApprovalDefinitionApprover]([fkApprovalDefinitionVersionID] ASC);
